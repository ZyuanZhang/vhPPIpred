...
def train_model_repeat_cv_eval(repeats=5, k=5, rf_n_estimators=500, rf_max_depth=3):
    # 加载数据
    ...
    df_all.to_csv("./tmp/cv_res_rf_vgenome_5kmer.csv", index=False)
...
def test_model_on_independent_set(repeats=5, rf_n_estimators=500, rf_max_depth=3):
    ...
    df_test.to_csv("./tmp/test_res_rf_vgenome_5kmer.csv", index=False)
